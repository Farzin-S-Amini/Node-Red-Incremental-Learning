...
module.exports = function(RED){
	function MNLogisticRegressionNode(config){
		const path = require('path')
		const utils = require('./utils/utils')

		var node = this;
		//set configurations
		node.file = __dirname + '/MNLogisticRegression.py'
		node.config = {
	...
	RED.nodes.registerType("MNLogisticRegression", MNLogisticRegressionNode)
}
